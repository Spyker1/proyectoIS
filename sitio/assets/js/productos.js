window.onload = function () {
    ...
    var currentSlide = 0;
    // var slideInterval = setInterval(nextSlide, 5000);  /// le da animcacion automatica
    ...
    var up = document.getElementsByClassName('mas')[0],
        down = document.getElementsByClassName('menos')[0],
